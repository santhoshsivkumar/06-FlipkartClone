...
const Checkout = () => {
  ...
  return (
    <div className="theme theme_text w-full lg:min-h-[calc(100vh-3.5rem)] gap-4 flex flex-col md:flex-row py-6 px-[5px] md:px-6 lg:px-28">
      ...
      <div className="flex flex-col gap-4 md:w-7/12 lg:w-2/3 ">
        ...
        <div className="theme_container shadow-sm w-full flex flex-col p-4">
          <div className=" flex items-center font-semibold pb-2">
            ...
            <span className="pl-4 text-md text-gray-500">DELIVERY ADDRESS</span>
            <span className="pl-2 theme_color">
              <MdDone />
            </span>
          </div>
        ...
        <div className="theme_container shadow-sm w-full flex flex-col p-4">
          <div className=" flex items-center font-semibold pb-2">
            ...
            <span className="pl-4 text-md text-gray-500">ORDER SUMMARY</span>
            <span className="pl-2 theme_color">
              <MdDone />
            </span>
          </div>
        ...
        <div className="theme_container shadow-sm w-full flex flex-col p-4">
          <div className=" flex items-center font-semibold pb-2">
            ...
            <span className="pl-4 text-md text-gray-500">PAYMENT OPTIONS</span>
            <span className="pl-2 theme_color">
              <MdDone />
            </span>
          </div>
            ...
            <div className="theme_text flex-row items-center gap-4 flex pt-2 pl-[38px] text-sm font-semibold">
              ...
              <div className="flex flex-col gap-2 w-full ">
                ...
                <div className="flex items-center justify-between gap-2">
                  ...
                  <div className="theme_container hidden p-2 w-full md:flex items-center justify-end">
                    {" "}
                    <button
                      title="ADD TO CART"
        ...
        {loading ? (
          ...
          <>
            ...
            <div className="flex justify-between border-dashed theme_border border-y-[1px] p-4 items-center">
              <h3 className="theme_text font-bold text-lg">Total Payable</h3>
      ...
      {/* 5 hidden on sm */}
      <div className="flex p-2 w-full md:hidden items-center justify-end">
        {" "}
        <button
          title="ADD TO CART"
          className={`bg-orange-500 py-3 px-12  text-white font-semibold`}
